...
#+RST: .. status: draft
#+LANGUAGE: de
#+OPTIONS: tex:t todo:t pri:nil tags:t texht:nil ':t
...
*** Was soll das Script leisten?
    ...
    1. Die Benutzerin/der Benutzer übergibt dem Programm die (lokale) MMS-ID des
       bibliografischen Datensätzes und die MMS-ID des Zielholdings.
    ...
    3. Über einen Abgleich mit dem Zielholding werden die Exemplare
       ...
       deren Signatur mit der Signatur des Zielholdings /beginnt/.
    ...
    5. Nun werden an jedem einzelnen Item folgende Änderungen vorgenommen
       ...
       - Der Exemplarstatus wird auf =null= gesetzt.
    6. Danach werden die Exemplare an das Zielholding verschoben ([[move-item]]):
    ...
    Alle Vorgänge werden in einem Logfile dokumentiert. Nachdem ein Programmlauf
