...
***** Imports etc.
      ...
      - =conf= :: lokale Konfiguration in der Datei =conf.py=. Aus dieser Datei
                  holen wir uns den API_KEY und das Arbeitsverzeichnis. Nachdem
                  man dort den API_KEY hineinschreibt, sollte diese Datei
                  in =.gitignore=.
...
* Beispiel für ein =conf.py=
  #+BEGIN_SRC python :noweb yes :tangle multi_hol/conf.py
    import os
    import keyring

    WORKING_DIR = os.path.join(os.path.expanduser("~"), "Y", "MULTI-HOL", "TEST")
