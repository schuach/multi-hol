...
***** Vor dem Ausführen prüfen ob es Bestellposten an Quellholdings gibt
      Wenn mit einem Nicht-Zielholding eine Bestellnummer verknüpft ist, kann
      das zu Fehlern führen, bei denen Exemplare verloren gehen. Diese können
      zwar wieder hergestellt werden, aber das ist aufwändig und vermeidbar.
      Bitte daher vorher prüfen, ob eines der Quellholdings mit einem
      Bestellposten verbunden ist. Wenn das der Fall ist, bitte den
      Bestellposten von diesem Holding lösen. Nachdem die Bereinigung
      abgeschlossen ist, kann das Zielholding bei Bedarf mit diesem
      Bestellposten verbunden werden.
