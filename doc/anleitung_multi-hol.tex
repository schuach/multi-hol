...
\begin{center}
\includegraphics[width=8cm]{/home/schuhs/projects/multi-hol/doc/pic/start_edit.png}
\end{center}

Kopieren Sie die Nummer hinein.
\subsection{Das Ziel-Holding identifizieren/anlegen}
\label{sec:org9ca5b86}
...
\begin{center}
\includegraphics[width=6cm]{/home/schuhs/projects/multi-hol/doc/pic/mmsid_editor.png}
\end{center}
\end{enumerate}
\subsection{Das Programm ausführen}
\label{sec:org6d31045}
